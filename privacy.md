...
<section class="privacy-summary" aria-label="Résumé de la politique">
  <div><span>Usage</span><strong>Strictement personnel</strong></div>
  <div><span>Vente des données</span><strong>Jamais</strong></div>
  <div><span>Révocation</span><strong>À tout moment</strong></div>
</section>

<div class="document-layout">
  <nav class="document-nav" aria-label="Sommaire de la politique">
    <p>Sur cette page</p>
    <ol>
      <li><a href="#champ-application">Champ d’application</a></li>
      <li><a href="#donnees-gmail">Données Gmail utilisées</a></li>
      <li><a href="#finalite">Finalité</a></li>
      <li><a href="#prestataires">Prestataires techniques</a></li>
      <li><a href="#conservation">Conservation et sécurité</a></li>
      <li><a href="#controle">Contrôle et révocation</a></li>
  ...
  <article class="legal-document">
    ...
    <section id="finalite">
      ...
      <h2>Finalité</h2>
      <p>Ces données sont utilisées uniquement pour aider le propriétaire à examiner, classer et nettoyer sa propre messagerie. Elles ne sont pas utilisées à des fins publicitaires ni pour entraîner un modèle destiné à des tiers.</p>
    </section>
    ...
    <section id="contact">
      ...
      <h2>Contact</h2>
      <p>Toute question relative à cette application peut être adressée au propriétaire du dépôt GitHub qui publie cette page.</p>
      <a class="button button--secondary" href="https://github.com/artwork278/hermes-personnel">Consulter le dépôt GitHub</a>
    </section>
  </article>
</div>
